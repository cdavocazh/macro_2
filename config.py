...
try:
    ...
    FRED_API_KEY = st.secrets.get('FRED_API_KEY', os.getenv('FRED_API_KEY', 'b4580ee69e5d56057d81490b590e4e95'))
except (ImportError, FileNotFoundError, KeyError):
    # Fall back to environment variable or hardcoded key
    FRED_API_KEY = os.getenv('FRED_API_KEY', 'b4580ee69e5d56057d81490b590e4e95')
